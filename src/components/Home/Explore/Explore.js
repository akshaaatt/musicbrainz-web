            ...
            <div className="container">
                ...
                <div className="row">
                    ...
                    <div className="col-md-6 d-flex" data-aos="fade-left">
                        <div className="card">
                            <div className="card-body">
                                <h5 className="card-title"><a href="https://musicbrainz.org/doc/MusicBrainz_Database" target="_blank">MusicBrainz Database</a></h5>
                                <p className="card-text">
                    ...
                    <div className="col-md-6 d-flex" data-aos="fade-left">
                        <div className="card">
                            <div className="card-body">
                                <h5 className="card-title"><a href="https://musicbrainz.org/doc/How_Editing_Works" target="_blank">Editing Philosophy</a></h5>
                                <p className="card-text">
